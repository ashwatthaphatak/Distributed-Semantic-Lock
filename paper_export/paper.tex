...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\columnwidth,height=5.5cm,keepaspectratio]{figures/01_paraphrase_gauntlet_ser_score.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\columnwidth,height=5.5cm,keepaspectratio]{figures/02_violation_heatmap.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\columnwidth,height=6cm,keepaspectratio]{figures/04_precision_recall_f1.png}
...
\begin{figure*}[t]
  \centering
  \includegraphics[width=\linewidth]{figures/03_confusion_matrices_theta075.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\columnwidth,height=5.5cm,keepaspectratio]{figures/06_embedding_overhead.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\columnwidth,height=5.8cm,keepaspectratio]{figures/timing_01_wait_time_summary.png}
...
\begin{figure*}[t]
  \centering
  \includegraphics[width=\linewidth]{figures/timing_02_latency_component_breakdown.png}
...
\begin{figure}[htbp]
  ...
  \begin{subfigure}[b]{\columnwidth}
    \includegraphics[width=\columnwidth,height=4.2cm,keepaspectratio]{figures/timing_timeline_case_01_the_thundering_herd.png}
    \caption{C1: Thundering Herd — 13 agents serialized in FIFO order.}
    \label{fig:timeline-herd}
  \end{subfigure}
  \vspace{0.2em}
  \begin{subfigure}[b]{\columnwidth}
    \includegraphics[width=\columnwidth,height=4.2cm,keepaspectratio]{figures/timing_timeline_case_08_queue_hopping.png}
...
\begin{figure}[htbp]
  ...
  \begin{subfigure}[b]{0.48\columnwidth}
    \includegraphics[width=\textwidth,height=4.8cm,keepaspectratio]{figures/matrix_02_fairness_by_theta.png}
    \caption{Wait fairness vs.\ $\theta$}
    \label{fig:fairness}
  \end{subfigure}
  \hfill
  \begin{subfigure}[b]{0.48\columnwidth}
    \includegraphics[width=\textwidth,height=4.8cm,keepaspectratio]{figures/matrix_03_blocked_rate_by_theta.png}
